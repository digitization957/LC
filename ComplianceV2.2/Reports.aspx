<%@ Page Title="Compliance Management App — Reports" Language="C#" AutoEventWireup="true" CodeBehind="Reports.aspx.cs" Inherits="ComplianceV2._2.Reports" %>
<!DOCTYPE html>
<html lang="en">
<head runat="server">
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <title>Compliance Management App — Reports</title>
...
<body>
    ...
    <div class="container">
        <div class="page-head">
            ...
            <p>Click a compliance for its full history.</p>
        </div>
        <div id="reportsBody">
    ...
    <script src="Scripts/reports.js?v=12"></script>
</body>
</html>
