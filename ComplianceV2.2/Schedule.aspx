<%@ Page Title="Compliance Management App — Schedule" Language="C#" AutoEventWireup="true" CodeBehind="Schedule.aspx.cs" Inherits="ComplianceV2._2.Schedule" %>
<!DOCTYPE html>
<html lang="en">
<head runat="server">
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <title>Compliance Management App — Schedule</title>
    ...
    <link href="Content/app.css?v=34" rel="stylesheet" />
</head>
<body>
    <div class="navbar">
    ...
    <div class="container">
        <div class="page-head">
            ...
            <div class="page-head-row"><h1>Schedule</h1><div id="scheduleExportWrap"></div></div>
            <p>Your overdue compliances, and what's due in a date range you choose.</p>
        </div>
        <div id="scheduleBody">
