<%@ Page Title="Compliance Management App — Overview" Language="C#" AutoEventWireup="true" CodeBehind="Report.aspx.cs" Inherits="ComplianceV2._2.Report" %>
<!DOCTYPE html>
<html lang="en">
<head runat="server">
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <title>Compliance Management App — Overview</title>
...
<body>
    ...
    <div class="container">
        <div class="page-head">
            ...
            <p>A cross-plant view of compliance health — overdue items, what's coming up, and recent activity.</p>
        </div>
        <div id="reportBody">
    ...
    <script src="Scripts/report.js?v=10"></script>
</body>
</html>
