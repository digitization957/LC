<%@ Page Title="Compliance Management App — Compliance Portal" Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="ComplianceV2._2._Default" %>
<!DOCTYPE html>
<html lang="en">
<head runat="server">
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <title>Compliance Management App — Compliance Portal</title>
...
<body>
    ...
    <script src="Scripts/app.js?v=21"></script>
</body>
</html>
